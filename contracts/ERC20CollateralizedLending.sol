...
// contract ERC20CollateralizedLending {

//     // global variables that set by borrowers
//     address payable public borrower  = 0x0;                // Borrower's wallet address
//     uint public repaymentAmount   = 0;                     // How much wei Borrower request from Lender
//     uint public repaymentAmount  = 0;                      // How much premium in wei Borrower wants to pay to Lender
//     uint public collateralAmount = 0;                      // Count of ERC20-tokens Borrower wants to put as collateral
//     uint public loanDuration = 0;                          // Number of days to lend the loan
//     string public tokenName = "";                          // Name of the Stable ERC20-token Borrower putting as a collateral - USDC, CUSD, USDT, DAI, etc.
//     string public tokenInfoLink = "";                      // Token info link (optional) - Borrower OR we have it automated can put the link to the token's contract address
//     address public token_smartcontract_address = 0x0;      // Stable ERC20 Token's contract address - Borrower putting as a collateral

//     address payable public lender;                       // Lender's wallet address, who is going to provide the loan


//     // different states of LendingRequest contract 
//     // Initial state // Waiting for Stable ERC20 tokens from Borrower - after Borrower set the data and call "requestLoan" function
//     // When loan cancelled  // When ERC20 tokens received from borrower, now looing for Lender
//     // When money received from Lender and sent to Borrower // When loan defaulted by Borrower
//     // When loan paid in full by Borrower and finished
//     enum LoanStatus { 
//         Init, 
//         WaitingForTokens, 
//         Cancelled, 
...
//     // events
//     event LoanStateChanged(LoanStatus newLoanStatus);
//     event LoanRepaid();



//     // functions for handling the loan lifecycle 
//     function setBorrowersData(
//         uint _repaymentAmount,
//         uint _premiumAmount,
//         uint _collateralAmount,
//         uint _loanDuration,
//         string memory _tokenName,
//         string memory _tokenInfoLink,
//         address _token_smartcontract_address
//     ) public {
...
//         // change the state to WaitingForTokens
//         currentState = State.WaitingForTokens;
//         emit LoanStateChanged(currentState);
//     }
...
//     // Borrower can cancel the loan request
